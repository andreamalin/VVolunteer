...
public class Regiones{
	...
	public String elaborarDatos(Integer[] medicinaNecesitada, String nombreCentroSalud){
		String recomendacion = "|\n| Se reviso el inventario de '" + nombreCentroSalud + "' y el medicamento que se necesito,\n| y se llego a la siguiente conclusion: ";
	...
	// Consiguiendo los nombres de cada medicamento
	public String[] getMedicamentos(){
		String[] medicamento = new String[medicinas.length];

		// Metiendo los datos de los medicamentos en el string
		for(int i = 0; i < medicinas.length; i++){
			medicamento[i] = (medicinas[i]).getNombreMedicamento();
		}
