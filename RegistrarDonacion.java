...
public class RegistrarDonacion{
	...
	public String mostrarInformacion(Integer lugar){
		Integer posicion = lugar - 1;
		String mensaje = "";
		mensaje += "|\n|_________________________________________________\n";
		mensaje +="| Nos encontramos en: " + direcciones[posicion] +"\n";
		mensaje += "| El telefono al que se puede comunicar en este momento es al "+ telefonos[posicion] + "\n";
		mensaje += "|\n|_________________________________________________\n";
		return mensaje;
	}
